...
namespace Pizza.Controllers
{
    public class UserTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,UserPassword,UserName")] UserTable userTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,UserPassword,UserName")] UserTable userTable)
        {
            if (ModelState.IsValid)
            {

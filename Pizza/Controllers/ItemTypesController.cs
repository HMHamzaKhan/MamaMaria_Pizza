...
namespace Pizza.Controllers
{
    public class ItemTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "itemTypeID,itemTypeName")] ItemType itemType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "itemTypeID,itemTypeName")] ItemType itemType)
        {
            if (ModelState.IsValid)
            {
